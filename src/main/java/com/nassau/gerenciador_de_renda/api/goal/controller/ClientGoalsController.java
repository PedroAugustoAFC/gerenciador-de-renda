package com.nassau.gerenciador_de_renda.api.goal.controller;

import com.nassau.gerenciador_de_renda.api.goal.service.GoalService;
...
@RestController
@RequestMapping("/clients/{id}/goals")
