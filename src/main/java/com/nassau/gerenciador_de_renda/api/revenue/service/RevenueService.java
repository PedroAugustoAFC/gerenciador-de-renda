package com.nassau.gerenciador_de_renda.api.revenue.service;
...
import com.nassau.gerenciador_de_renda.api.revenue.repository.RevenueRepository;
...
public class RevenueService {
    ...
    public RevenueDTO updateRevenue(UUID id, RevenueUpdateDTO updatedRevenue){
        ...
        if(updatedRevenue.getAmount() != null && updatedRevenue.getAmount().compareTo(BigDecimal.ZERO) != 0){
            if(existingRevenue.getAmount().compareTo(updatedRevenue.getAmount()) == 0){
